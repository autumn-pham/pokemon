...
const App = () => {
  ...
  useEffect(() => {
    ...
    .then(res => {
      ...
      // newPokemon = res.data.results.map(p => p.name, q => q.url)
      // setPokemon(newPokemon)
